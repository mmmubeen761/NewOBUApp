    ...
    return (
        <>
            <View style={styles.action}>
                ...
                />
                <Text style={styles.textInput}>Buy Crypto</Text>
            </View>
            <ScrollView>
                <View style={styles.textWrapper}>
                    <View style={styles.logincontainer}>
                        ...
                        <View style={styles.actions}>
                            <Text style={{ color: 'black', fontSize: hp('3%') }}>No crypto</Text>
                        </View>
                        <View style={styles.actions}>
                            <Text style={{ color: 'black' }}>Looks like your wallet is empty, we can help you</Text>
                        </View>
                        <View style={styles.actions}>
                            <Text style={{ color: 'black' }}>to buy crypto</Text>
                        </View>
                        <View style={styles.actions}>
