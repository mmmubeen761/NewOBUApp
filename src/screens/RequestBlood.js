...
const RequestBlood = (props) => {
    ...
    const [req,setReq] = useState('DONATE');
    const [request,setRequest] = useState('donating');
            ...
            <ScrollView style={{ backgroundColor: '#fff' }}>
                <View style={styles.container}>
                    <View style={styles.logincontainer}>
                        <Text style={{ fontSize: 25, fontWeight: 'bold', paddingBottom: 10, paddingTop: 30 }}>Request Blood</Text>
                        ...
                        <View style={styles.textAreaContainer} >
                            <TextInput
                                style={styles.textArea}
                                underlineColorAndroid="transparent"
                                placeholder="Place to Request (City, State, Hospital, address etc.)"
                                placeholderTextColor="grey"
                                numberOfLines={10}
                                multiline={true}
